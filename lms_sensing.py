...
connection = mysql.connector.connect(host="localhost", user="XXXXXXXXXXX", password="XYXYXYXYXY", database="YYYYYYYYYY")
...
# sense, save to database, and update tempertaure and humidity every 2 seconds
read_temp_humdity()
